 <p align="center">
    <br>
    <img src="https://github.com/odejinmi/tflite_flutter_plus/blob/master/docs/tflite_flutter_cover.png"/>
    </br>
</p>
<p align="center">
...
1. Place the script [install.sh](https://github.com/odejinmi/tflite_flutter_plus/blob/master/install.sh) (Linux/Mac) or [install.bat](https://github.com/odejinmi/tflite_flutter_plus/blob/master/install.bat) (Windows) at the root of your project.
...
These scripts install pre-built binaries based on latest stable tensorflow release. For info about using other tensorflow versions follow [instructions in wiki](https://github.com/odejinmi/tflite_flutter_plus/wiki/).

### iOS

1. Download [`TensorFlowLiteC.framework`](https://github.com/odejinmi/tflite_flutter_plus/releases/download/v0.5.0/TensorFlowLiteC.framework.zip). For building a custom version of tensorflow, follow [instructions in wiki](https://github.com/odejinmi/tflite_flutter_plus/wiki/).
...
Follow instructions in [this guide](https://github.com/odejinmi/tflite_flutter_plus/wiki/Building-Desktop-binaries-with-XNNPack-Delegate) to build and use desktop binaries.

## TFLite Flutter Helper Library

A dedicated library with simple architecture for processing and manipulating input and output of TFLite Models. API design and documentation is identical to the TensorFlow Lite Android Support Library. Strongly recommended to be used with `tflite_flutter_plugin`. [Learn more](https://github.com/odejinmi/tflite_flutter_helper_plus).

## Examples

|Title|Code|Demo|Blog|
|-----|----|----|----|
|Text Classification App| [Code](https://github.com/odejinmi/tflite_flutter_plus/tree/master/example)|<img src="https://github.com/odejinmi/tflite_flutter_plus/raw/master/example/demo.gif" width=120/> |[Blog/Tutorial](https://medium.com/@am15hg/text-classification-using-tensorflow-lite-plugin-for-flutter-3b92f6655982)| 
|Image Classification App| [Code](https://github.com/odejinmi/tflite_flutter_helper_plus/tree/master/example/image_classification)|<img src="https://github.com/odejinmi/tflite_flutter_helper_plus/raw/master/example/image_classification/demo.gif" width=120/> |-|
...
Refer [Tests](https://github.com/odejinmi/tflite_flutter_plus/blob/master/example/integration_test/tflite_flutter_test.dart) to see more example code for each method.
